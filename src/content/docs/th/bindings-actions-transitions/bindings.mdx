---
title: 'Bindings'
description: 'two-way binding — bind:value, bind:checked, bind:group, bind:this และ binding กับ component prop — และเป็น sugar ของ value บวก event อย่างไร'
sidebar:
  order: 2
---
...
export const quizBindings = [
  ...
  {
    q: 'child ต้องประกาศอะไรเพื่อให้ parent `bind:` กับ prop ของตัวเองได้?',
    options: [
      'export let',
