...
export const quizVs = [
  ...
  },
  {
    ...
    options: [
      'object เร็วกว่า',
      'การ import ค่าเปล่า ๆ จะ copy ค่าออกมาและเสีย reactivity ส่วน object ทำให้ทุกคนยังชี้ไปที่ reactive proxy ตัวเดียวกัน',
